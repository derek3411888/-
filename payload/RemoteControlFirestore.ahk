...
global RC_HEARTBEAT_INTERVAL_MS := 30000
...
RC_Init(cfgPath, onStateChangedCallback := "") {
    ...
    RC_HEARTBEAT_INTERVAL_MS := RC_ToIntRange(RC_IniReadSafe(cfgPath, "remote_control", "heartbeat_interval_ms", "30000"), 30000, 3000, 300000)
