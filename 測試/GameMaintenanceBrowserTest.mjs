...
window.calls=[];window.input={uid:'fixture',deviceFresh:true,effectiveSettings:{maintenanceEnabled:true},ack:{},value:{schemaVersion:1,capabilityVersion:1,phase:'WAIT_OPEN',provider:'steam',eventId:'fixture-1',observedAt:Date.now(),observedUtcNow:Date.now(),expectedOpenAt:Date.now()+120000,checkedAt:Date.now(),detail:'官方公告仍在維護，等待開服後確認更新。'.repeat(20),sourceUrl:'https://wutheringwaves.kurogames.com/tw/main/news/detail/5280'}};
